...
describe('Custom Tests', function () {
  ...
  it('[assignment] iii. see assignment doc for details', async () => {
    ...
    const bobEthAddress = '0xa54d3c09E34aC96807c1CC397404bF2B98DC4eFb'
    ...
    const aliceEthAddress = '0xDeaD00000000000000000000000000000000BEEf'
    const aliceChangeUtxoAll = new Utxo({ amount: 0, keypair: aliceKeypair })
    await transaction({
      tornadoPool,
      inputs: [aliceChangeUtxo],
      outputs: [aliceChangeUtxoAll],
      recipient: aliceEthAddress,
      isL1Withdrawal: true,
    })
